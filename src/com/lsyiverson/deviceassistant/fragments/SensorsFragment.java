...
public class SensorsFragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new SimpleAdapter(getActivity(), mSensorItemList, R.layout.sensor_info_item, new String[] {Constants.LIST_NAME, Constants.LIST_VALUE},
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (sensor.getType()) {
            case Sensor.TYPE_ACCELEROMETER:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_acceleration, x_accelerometer, y_accelerometer, z_accelerometer));
                builder.append("\n");
                break;
            case Sensor.TYPE_AMBIENT_TEMPERATURE:
                boolean use_celsius = BatteryUtils.getUseCelsius(getActivity());
                float ambient_temperature = event.values[0];
                if (use_celsius) {
                    builder.append(getActivity().getString(R.string.sensor_temperature_celsius, ambient_temperature));
                } else {
                    ambient_temperature = (float)(ambient_temperature * 1.8 + 32);
                    builder.append(getActivity().getString(R.string.sensor_temperature_fahrenheit, ambient_temperature));
                }
                builder.append("\n");
                break;
            case Sensor.TYPE_GAME_ROTATION_VECTOR:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz, String.format("%.5f", x_game_rotation), String.format("%.5f", y_game_rotation), String.format("%.5f", z_game_rotation)));
                builder.append("\n");
                break;
            case Sensor.TYPE_GEOMAGNETIC_ROTATION_VECTOR:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz, String.format("%.5f", x_geomagnetic_rotation), String.format("%.5f", y_geomagnetic_rotation), String.format("%.5f", z_geomagnetic_rotation)));
                builder.append("\n");
                break;
            case Sensor.TYPE_GRAVITY:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_acceleration, x_gravity, y_gravity, z_gravity));
                builder.append("\n");
                break;
            case Sensor.TYPE_GYROSCOPE:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_gyroscore, x_gyroscore, y_gyroscore, z_gyroscore));
                builder.append("\n");
                break;
            case Sensor.TYPE_GYROSCOPE_UNCALIBRATED:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_gyroscore, x_gyroscore_uncalibrated, y_gyroscore_uncalibrated, z_gyroscore_uncalibrated));
                builder.append("\n");
                builder.append(getActivity().getString(R.string.sensor_xyz_gyroscore_estimated_drift, x_estimated_drift, y_estimated_drift, z_estimated_drift));
                builder.append("\n");
                break;
            case Sensor.TYPE_LIGHT:
                float light = event.values[0];
                builder.append(getActivity().getString(R.string.sensor_light, light));
                builder.append("\n");
                break;
            case Sensor.TYPE_LINEAR_ACCELERATION:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_acceleration, x_linear_accelerometer, y_linear_accelerometer, z_linear_accelerometer));
                builder.append("\n");
                break;
            case Sensor.TYPE_MAGNETIC_FIELD:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_magnetic_field, x_magnetic_field, y_magnetic_field, z_magnetic_field));
                builder.append("\n");
                break;
            case Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz_magnetic_field, x_uncali, y_uncali, z_uncali));
                builder.append("\n");
                builder.append(getActivity().getString(R.string.sensor_xyz_magnetic_field_bias, x_bias, y_bias, z_bias));
                builder.append("\n");
                break;
            case Sensor.TYPE_ORIENTATION:
                ...
                builder.append(getActivity().getString(R.string.sensor_orientation, azimuth, pitch, roll));
                builder.append("\n");
                break;
            case Sensor.TYPE_PRESSURE:
                float pressure = event.values[0];
                builder.append(getActivity().getString(R.string.sensor_pressure, pressure));
                builder.append("\n");
                break;
            case Sensor.TYPE_PROXIMITY:
                float distance = event.values[0];
                builder.append(getActivity().getString(R.string.sensor_proximity, distance));
                builder.append("\n");
                break;
            case Sensor.TYPE_RELATIVE_HUMIDITY:
                float relative_humidity = event.values[0];
                builder.append(getActivity().getString(R.string.sensor_relative_humidity, relative_humidity));
                builder.append("\n");
                break;
            case Sensor.TYPE_ROTATION_VECTOR:
                ...
                builder.append(getActivity().getString(R.string.sensor_xyz, String.format("%.5f", x_rotation), String.format("%.5f", y_rotation), String.format("%.5f", z_rotation)));
                builder.append("\n");
                break;
            ...
            case Sensor.TYPE_STEP_COUNTER:
                ...
                builder.append(getActivity().getString(R.string.sensor_step, step_offset));
                builder.append("\n");
                break;
            case Sensor.TYPE_STEP_DETECTOR:
                float step_detector = event.values[0];
                builder.append(getActivity().getString(R.string.sensor_step, step_detector));
                builder.append("\n");
                break;
            case Sensor.TYPE_TEMPERATURE:
                boolean is_use_celsius = BatteryUtils.getUseCelsius(getActivity());
                float temperature = event.values[0];
                if (is_use_celsius) {
                    builder.append(getActivity().getString(R.string.sensor_temperature_celsius, temperature));
                } else {
                    temperature = (float)(temperature * 1.8 + 32);
                    builder.append(getActivity().getString(R.string.sensor_temperature_fahrenheit, temperature));
                }
                builder.append("\n");
                break;
        }
        builder.append(getActivity().getString(R.string.sensor_current_consumption, sensor.getPower()));
